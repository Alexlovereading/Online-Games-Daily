/**
 * Cupcake 2048 game logic — reuses the exact slide/merge/win-loss algorithm
 * from ../game-2048/game-core.ts (itself adapted from jinhucheung/2048-react,
 ...
 * Only the visual presentation differs (cupcake theme) — the board math is
 * identical, so tile values stay numeric (2, 4, 8, ... 2048) and are mapped
 * to cupcake emoji/colors in Cupcake2048Game.tsx.
 */
